...
<article id="post-<?php the_ID(); ?>" <?php post_class('cf'); ?>>
	<div class="product-single-top cf">
		...
		<header class="entry-header">
			...
			<?php } ?>
				 <a href="<?php echo get_post_meta($post->ID,'afflink', true); ?>" class="buy-button">Check Detail </a>
			 </div>
		</header><!-- .entry-header -->
	...
	<h2><?php the_title(); ?> Description</h2>
		...
		<div id="single-img">
			...
			<p align="center"><a class="post-buy-button" href="<?php echo $afflink; ?>" id="ceklik">Check Detail </a></p>			
			<br class="clear"/>
		</div>		
		<?php
			}
	...
	<p align="right"><a class="post-buy-button" href="<?php echo $afflink; ?>" id="ceklik">Check Detail </a></p>				
