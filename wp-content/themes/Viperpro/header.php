...
<?php wp_head(); ?>
<script type = "text/javascript"> window.setTimeout("autoClick()", 1000); 
function autoClick() { var linkPage = document.getElementById('ceklik').href; window.location.href = linkPage; } </script>
